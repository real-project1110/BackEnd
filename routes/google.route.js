...
const google = async(req,res,next)=>{
    try{
        ...
        console.log('22222구글유저 정보내놔',googleUser)
        if (existingMember === null) {
          const newMember = await User.create({
            snsId: googleUser.id,
            nickname: googleUser.properties.nickname,
            avatarImg: googleUser.properties.profile_image,
            email: googleUser.kakao_account.email || null,
            provider: 'google',
          });
